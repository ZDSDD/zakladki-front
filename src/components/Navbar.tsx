...
const Navbar = () => {
  return (
    <nav className="shadow-md sticky top-0 mb-5 z-50 w-full border-b border-green-500 bg-background/30 backdrop:blur supports-[backdrop-filter]:bg-background/80">
